...
void exact_dt_R(double *, double *, int *, int *, double *, double *, double *, double *, int *, int *, int *, int *, double *, int *, double *);
...
void nnXinterface(int *, double *, double *, int *, int *, double *, double *, int *, int *, int *, int *, int *, double *, int *, double *); 
void knnXinterface(int *, double *, double *, int *, int *, double *, double *, int *, int *, int *, int *, int *, int *, double *, int *, double *);
void nndist2sort(int *, double *, double *, double *, double *); 
void nndistsort(int *, double *, double *, double *, double *); 
void knnd2sort(int *, int *, double *, double *, double *, double *); 
...
void nnGinterface(int *, double *, double *, int *, double *, double *, int *, double *, double *, int *, int *, int *, double *, int *, double *); 
void knnGinterface(int *, double *, double *, int *, double *, double *, int *, double *, double *, int *, int *, int *, int *, double *, int *, double *);
